...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[18] =
        {
            {float3{0, 0, -0.35}, float4{1,0, 0, 1}},     // 0 Center
            {float3{-1, 0, 0}, float4{0, 1, 0, 1}},        // 1
            {float3{-0.35, -0.17, 0}, float4{0, 0, 1, 1}}, // 2
            {float3{-0.7, -0.7, 0}, float4{1, 0, 0, 1}},   // 3 
            {float3{-0.17, -0.35, 0}, float4{0, 1, 0, 1}}, // 4
            {float3{0, -1, 0}, float4{0, 0, 1, 1}},        // 5
            {float3{0.17, -0.35, 0}, float4{1, 0, 0, 1}},  // 6
            {float3{0.7, -0.7, 0}, float4{0, 1, 0, 1}},    // 7 
            {float3{0.35, -0.17, 0}, float4{0, 0, 1, 1}},  // 8
            {float3{1, 0, 0}, float4{1, 0, 0, 1}},         // 9 
            {float3{0.35, 0.17, 0}, float4{0, 0, 1, 1}},   // 10
            {float3{0.7, 0.7, 0}, float4{1, 0, 0, 1}},     // 11
            {float3{0.17, 0.35, 0}, float4{0, 1, 0, 1}},   // 12
            {float3{0, 1, 0}, float4{0, 0, 1, 1}},         // 13
            {float3{-0.17, 0.35, 0}, float4{1, 0, 0, 1}},  // 14
            {float3{-0.7, 0.7, 0}, float4{0, 1, 0, 1}},    // 15
            {float3{-0.35, 0.17, 0}, float4{0, 0, 1, 1}},  // 16
            {float3{0, 0, 0.35}, float4{1, 0, 0, 1}},      // 17 Center
...
void Tutorial02_Cube::Render()
{
    ...
    DrawAttrs.NumIndices = 96; // Cambio de indices posibles
